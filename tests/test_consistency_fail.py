...
def test_main_consistency_missing_args():
    ...
    result = subprocess.run(
        [sys.executable, "src/myproject/main.py", "--consistency", "--tree-size", "26102321", "--root-hash", "42a074539f68d47a158a74095090ee0b54908b1392c2021561bdea9fe5df8943"],
        capture_output=True,
        text=True
    )
    ...
    result = subprocess.run(
        [sys.executable, "src/myproject/main.py", "--consistency", "--tree-id", "1193050959916656506", "--root-hash", "42a074539f68d47a158a74095090ee0b54908b1392c2021561bdea9fe5df8943"],
        capture_output=True,
        text=True
    )
    ...
    result = subprocess.run(
        [sys.executable, "src/myproject/main.py", "--consistency", "--tree-id", "1193050959916656506", "--tree-size", "26102321"],
        capture_output=True,
        text=True
    )
